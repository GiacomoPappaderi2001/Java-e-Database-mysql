...
import java.net.*;
import java.util.*;
public class JavaWebServerDESEJsXML implements Runnable{ 
	...
	public JavaWebServerDESEJsXML(Socket c) {
		connect = c;
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (true) {
				JavaWebServerDESEJsXML myServer = new JavaWebServerDESEJsXML(serverConnect.accept());
		...
		try {
			...
			if (!method.equals("GET")  &&  !method.equals("HEAD")) {
                            ...
                            try {
                                ...
                                java.util.Vector <persona> allp = p1;
                                XmlMapper xmlMapper = new XmlMapper();
                            ...
                            try {
                                ...
                                prova p2= new prova();
                                java.util.Vector <persona> allp= p2.();
